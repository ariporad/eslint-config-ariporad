# @ariporad's CSS-in-JavaScript Style Guide

*A mostly reasonable approach to CSS-in-JavaScript, ~~Blatantly Stolen from~~ inspired by [AirBnB][]'s.*
...
## Ordering
  ...
  - Define styles after the component.
    ...
    > Why? This way, it's near `PropTypes` and other similar things. Additionally, if you need to
	  pass it to a higher-order component for any reason (ie. theming), it's already in the right
	  place.
